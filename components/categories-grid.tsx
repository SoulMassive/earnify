...
const categories = [
  { name: "Affiliate Marketing", icon: Megaphone, count: 124, bgColor: "bg-[#6d9c9f]" },
  { name: "Content Writing", icon: PenTool, count: 89, bgColor: "bg-[#e8a838]" },
  { name: "Graphic Design", icon: Palette, count: 67, bgColor: "bg-[#e91e8c]" },
  { name: "Coding & Dev", icon: Code, count: 54, bgColor: "bg-[#7c3aed]" },
  { name: "Online Tutoring", icon: GraduationCap, count: 98, bgColor: "bg-[#4caf7d]" },
  { name: "Data Entry", icon: BarChart3, count: 145, bgColor: "bg-[#8b5cf6]" },
  { name: "Social Media", icon: Share2, count: 76, bgColor: "bg-[#e05252]" },
  { name: "Video Editing", icon: Video, count: 43, bgColor: "bg-[#ef4444]" },
]
