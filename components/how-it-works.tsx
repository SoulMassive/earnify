...
const STEPS = [
  {
    ...
    description:
      "Start by clicking 'Start Earning' or 'Get Started for Free'. Enter your details and let us know your skills to set up your profile.",
    color: "from-teal-400 to-cyan-500",
    glow: "rgba(45,122,126,0.18)",
    highlight: "#2d7a7e",
    detail: "Step 1: Get your profile ready",
  },
  {
    id: 2,
    number: "02",
    ...
    description:
      "Browse hundreds of curated gigs, micro-tasks, and freelance jobs. Filter by Domain or Difficulty level to find the perfect match.",
    color: "from-violet-400 to-purple-500",
    glow: "rgba(124,58,237,0.15)",
    highlight: "#7c3aed",
    detail: "Step 2: Browsing & Filtering",
  },
  {
    id: 3,
    number: "03",
    ...
    title: "Start Working",
    description:
      "Pick your favorite gig and start working on optimizing your time! Submit work and get instant payouts to your account.",
    color: "from-amber-400 to-orange-500",
    glow: "rgba(245,158,11,0.15)",
    highlight: "#f59e0b",
    detail: "Success: Start earning now",
  },
]
