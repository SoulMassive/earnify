...
import { User, Mail, Lock, Eye, EyeOff, UserPlus, ChevronRight, ChevronLeft } from 'lucide-react'
    ...
    >
      ...
      <div className="mb-10">
        ...
        <p className="text-sm font-medium text-white/50 md:text-base">
          Start your journey as a student earner today.
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <motion.div variants={itemVariants} className="space-y-1.5">
          <label className="text-xs font-semibold tracking-wider text-white/40 uppercase">Full Name</label>
          <div className="group relative">
            <User className="absolute top-1/2 left-4 h-5 w-5 -translate-y-1/2 text-white/20 transition-colors group-focus-within:text-primary" />
            <input
              type="text"
              required
              value={name}
        ...
        {/* Email Address */}
        <motion.div variants={itemVariants} className="space-y-1.5">
          <label className="text-xs font-semibold tracking-wider text-white/40 uppercase">Email Address</label>
          <div className="group relative">
        ...
        {/* Password */}
        <motion.div variants={itemVariants} className="space-y-1.5">
          <label className="text-xs font-semibold tracking-wider text-white/40 uppercase">Create Password</label>
          <div className="group relative">
        ...
        {/* Confirm Password */}
        <motion.div variants={itemVariants} className="space-y-1.5">
          <label className="text-xs font-semibold tracking-wider text-white/40 uppercase">Confirm Password</label>
          <div className="group relative">
            <Lock className="absolute top-1/2 left-4 h-5 w-5 -translate-y-1/2 text-white/20 transition-colors group-focus-within:text-primary" />
            <input
              type={showPassword ? 'text' : 'password'}
      ...
      <motion.div variants={itemVariants} className="my-8 flex items-center gap-4">
        ...
        <span className="text-xs font-bold text-white/20 uppercase tracking-widest leading-none">OR JOIN WITH</span>
        <div className="h-[1px] flex-1 bg-white/5" />
      </motion.div>
      ...
      <motion.p 
        variants={itemVariants}
        className="mt-8 text-center text-sm font-medium text-white/50"
      >
